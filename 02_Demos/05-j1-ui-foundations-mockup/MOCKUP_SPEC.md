# Spec mockup · Profile card

SoT cho demo — thay cho file Figma.
...
- Bio: Đang học UI Foundations: semantics, box model, flex/grid, UI library theo docs — rồi mới tinh chỉnh mắt.
